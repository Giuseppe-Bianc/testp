...
// configuration step. It creates a namespace called `testp`. You can modify
...
{
  try {
    CLI::App app{ fmt::format("{} version {}", testp::cmake::project_name, testp::cmake::project_version) };
